...
class TranslationalConstraint
{
	...
	public function preSolve(timeStep:Float, invTimeStep:Float):Void
	{
		...
		motorDenom = m1 + m2 + ax * (a1y * r1z - a1z * r1y + a2y * r2z - a2z * r2y) + ay * (a1z * r1x - a1x * r1z + a2z * r2x - a2x * r2z) + az * (a1x * r1y - a1y * r1x + a2x * r2y - a2y * r2x)
		;
	...
	{
		var rvn:Float = ax * (l2.x - l1.x) + ay * (l2.y - l1.y) + az * (l2.z - l1.z) + t2x * a2.x - t1x * a1.x + t2y * a2.y - t1y * a1.y + t2z * a2.z - t1z * a1.z
		;
