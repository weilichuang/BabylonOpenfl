...
class AngularConstraint
{
	...
	private var targetOrientation:Quaternion;
	private var relativeOrientation:Quaternion;
	...
	public function new(joint:Joint, targetOrientation:Quaternion)
	{
		this.joint = joint;
		this.targetOrientation = new Quaternion().invert(targetOrientation);
	...
	public function preSolve(timeStep:Float, invTimeStep:Float):Void
	{
		...
		var inv:Float = 1 / (v00 * (v11 * v22 - v21 * v12) + v10 * (v21 * v02 - v01 * v22) + v20 * (v01 * v12 - v11 * v02));
